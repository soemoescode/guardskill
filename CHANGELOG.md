...
Closes all seventeen findings from the first independent security review, against an acceptance gate written before the work started. Detection stays at git level; a separate confidence axis and the next detection class move to 0.5.0.

**Security — false negatives that let a working attack through**
